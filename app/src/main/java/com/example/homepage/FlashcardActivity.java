...
//                snackbar.show();
        ...
        incorrectAnswer1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                incorrectAnswer1.setBackgroundColor(getResources().getColor(R.color.tomato));
                incorrectAnswer2.setBackgroundColor(getResources().getColor(R.color.orange));
                correctAnswer.setBackgroundColor(getResources().getColor(R.color.orange));
            }
        });
        ...
        incorrectAnswer2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                incorrectAnswer2.setBackgroundColor(getResources().getColor(R.color.tomato));
                incorrectAnswer1.setBackgroundColor(getResources().getColor(R.color.orange));
                correctAnswer.setBackgroundColor(getResources().getColor(R.color.orange));
            }
        });
...
//        });
        ...
        addNewCardButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countdownTimer.cancel();
                Intent i = new Intent(FlashcardActivity.this, AddCard.class);
