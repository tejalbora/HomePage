...
public class dbManager extends SQLiteOpenHelper {
    ...
    public String deleteReminder(String title) {
        ...
        try{
            float result = database.delete("tbl_reminder",   "id =" + title, null);    //returns -1 if data successfully inserts into database
            ...
            Log.e(TAG, "Error while deleting record: " + e.getMessage());
